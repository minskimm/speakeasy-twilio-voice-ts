...
export function voiceV1ConnectionPolicyUpdateConnectionPolicy(
  client: TwilioVoiceCore,
  request: operations.UpdateConnectionPolicyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateConnectionPolicyResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateConnectionPolicyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateConnectionPolicyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
