...
export function voiceV1ConnectionPolicyCreateConnectionPolicy(
  ...
  Result<
    operations.CreateConnectionPolicyResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.CreateConnectionPolicyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
