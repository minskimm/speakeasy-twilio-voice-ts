...
export const tool$voiceV1SourceIpMappingDeleteSourceIpMapping = {
    name: "voice-v1-source-ip-mapping_delete-source-ip-mapping",
    description: ``,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await voiceV1SourceIpMappingDeleteSourceIpMapping(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
